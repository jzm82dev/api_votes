...
return new class extends Migration
{
    ...
    {
        Schema::create('tournament_couples_clasifications', function (Blueprint $table) {
            $table->id();
            $table->foreignId('tournament_id')->constrained()->onDelete('cascade')->onUpdate('cascade');
            $table->foreignId('category_id')->constrained()->onDelete('cascade')->onUpdate('cascade');
            $table->foreignId('couple_id')->nullable()->constrained('couples')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('tournament_couples_clasification');
    }
};
