...
class PermissionsDemoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['guard_name' => 'api','name' => 'list_speciality']);
        Permission::create(['guard_name' => 'api','name' => 'register_speciality']);
        Permission::create(['guard_name' => 'api','name' => 'edit_speciality']);
        Permission::create(['guard_name' => 'api','name' => 'delete_speciality']);
